...
//this function take date time slot strings and group them into a 
...
try{
 ...
 const b = req.body || {};
    ...
    }//if file present upload it will be uploaded to services folder in the cloudinary ;
