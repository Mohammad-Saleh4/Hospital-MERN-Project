...
//this function remove duplicates and sort the schedule slots for each date
...
//this function parse the schedule input from the client, which can be either a JSON string or an object, and then dedupe and sort the schedule slots   
...
//this function convert doctor data into plain text 
